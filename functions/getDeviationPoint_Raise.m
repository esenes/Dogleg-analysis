function [time_ind] = getDeviationPoint_Raise(timescale,signal_B0,signal_L1,tsignal,deviationLevel,noiseLevel)
%	getDeviationPoint_Raise.m check the deviation point between the signals
%	and assume as deviation point the one where the difference is higher
%	than a treshold and the B0 signal is higher than the L1 signal.
%
%   Inputs:
%   - timescale: 
%   - signla_B0, signal_L1: 
